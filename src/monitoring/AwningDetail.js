            ...
            <div className='bg-gray-100 pt-10'>
              <div className='flex justify-between p-1 border-b px-4'>
                <div className='flex pb-1 items-center'>
                  ...
                  <button className='border p-1 bg-white rounded-lg shadow-md'>수정하기</button>
                  <button className='border p-1 bg-white rounded-lg shadow-md ml-5'>삭제하기</button>
                </div>
