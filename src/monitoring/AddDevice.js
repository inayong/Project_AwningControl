...
const FormSection = ({ labelLeft, labelRight, leftRef, rightRef }) => {
  return (
    <div className='flex justify-around items-center py-3 pl-3 w-full'>
      ...
      <div className='flex flex-col justify-center space-y-1'>
        <div className='font-NIXGONMVb font-bold'>{labelRight}</div>
        <input className='w-48 border font-NanumSquareNeoVariable outline-none pl-1' ref={rightRef}></input>
      </div>
    </div>
  );
};
...
const AddDevice = () => {
  ...
  return (
    <div className='h-screen bg-white flex justify-center items-center'>
      <div className=' flex bg-white w-[80%] h-[80%] shadow-lg shadow-blue-100 rounded-lg'>
        <div className='flex  w-2/5 h-full'>
          <div id="map" style={{ width: '100%', height: '100%' }} className='rounded-l-lg'></div>
        </div>
        <div className='w-2/3 text-lg p-3 flex flex-col bg-neutral-100 rounded-r-lg'>
          <div className='flex justify-center text-xl font-bold p-1 pb-4'>
            <div className='border-4 border-double border-neutral-400 pt-3 pb-2 w-2/3 text-center rounded-lg font-GmarketSansMedium'>장치 추가</div>
          </div>
          <div className='flex-grow w-full'>
            <div className='flex flex-col pt-5 pb-3 pl-3'>
              <div className='flex pb-3 pl-3 justify-center'>
                ...
                <div className='flex'>
                  <div className='pr-3 font-NIXGONMVb font-bold'>위·경도</div>
            ...
            <div className='flex pb-3 pt-5 pl-3 justify-center'>
              <div className='flex'>
                ...
                <select onChange={handleSelGu} ref={selGuRef} value={selectedGu} className='w-28 mr-3 border font-NanumSquareNeoVariable'>
              ...
              <div className='flex'>
                <div className='pl-9 pr-3 font-NIXGONMVb font-bold'>회사 구분</div>
                <select ref={company} className='border w-28 font-NanumSquareNeoVariable'>
          ...
          <div className='flex justify-center m-1'>
            <button onClick={handleAddSubmit} className='border mr-3 pt-1 rounded-md px-3 hover:border-blue-400 font-NIXGONMVb font-bold'>추가</button>
            {showModal && (
              <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 flex justify-center items-center">
                <div className="bg-white p-16 rounded-md">
                  <p className='text-2xl font-GmarketSansMedium'>장치를 추가하시겠습니까?</p>
                  <div className="flex justify-center mt-4 pt-3">
                    <button onClick={AddDeviceConfirm} className="px-3 py-1 bg-red-500 text-white rounded-md font-NanumSquareNeoVariable">확인</button>
                    <button onClick={() => setShowModal(false)} className="ml-4 px-3 py-1 bg-gray-300 rounded-md font-NanumSquareNeoVariable">취소</button>
                  </div>
                </div>
              </div>
            )}
            <button onClick={cancleButton} className='border ml-3 pt-1 px-3 rounded-md hover:border-gray-400 font-NIXGONMVb font-bold'>취소</button>
          </div>
        </div>
      </div >
    </div >
